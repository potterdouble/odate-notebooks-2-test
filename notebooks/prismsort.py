...
# default parameters
FILENAME = "../data/pic01.jpg" # path to your image
...
def main():
    ...
    try:
        ...
        while iteration < NUM_OUTPUT:
            ...
            # saving the output
            if JPEG is None:
                im.save("../data/" + FILENAME.split('/')[2].split('.')[0]+'_out'+str(iteration)+".png")
            else:
                im.save("../data/" + FILENAME.split('/')[2].split('.')[0]+'_out'+str(iteration)+".jpg",
                        optimize=True,
                        quality=JPEG,
